...
with certain assembly code from OFFENSE_COIN's code. See [developer notes on sanitizers](https://github.com/OfFENSE-COIN/Offense/blob/master/doc/developer-notes.md#sanitizers)
