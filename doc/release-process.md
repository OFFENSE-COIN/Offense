...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/OFFENSE_COIN-Project/OFFENSE_COIN/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/offense_coin-project/offense_coin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/offense_coin-project/offense_coin-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/offense_coin-project/offense_coin.git
...
- Detached signatures will then be committed to the [offense_coin-detached-sigs](https://github.com/offense_coin-Project/offense_coin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/OFFENSE_COIN-Project/OFFENSE_COIN/releases/new) with a link to the archived release notes.
