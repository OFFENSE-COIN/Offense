...
extern const char * const OFFENSE_COIN_CONF_FILENAME;
extern const char * const OFFENSE_COIN_PID_FILENAME;
extern const char * const OFFENSE_COIN_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("offense_coin-%s", name);
