 ...
 *  A CTxDestination is the internal data type encoded in a OFFENSE_COIN address
 */
...
/**
 * Generate a OFFENSE_COIN scriptPubKey for the given CTxDestination. Returns a P2PKH
