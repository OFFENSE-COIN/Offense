...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " offense_coin-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  offense_coin-tx [options] <hex-tx> [commands]  Update hex-encoded offense_coin transaction\n" +
                               "or:     offense_coin-tx [options] -create [commands]   Create hex-encoded offense_coin transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded offense_coin transaction
