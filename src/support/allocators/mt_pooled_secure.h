...
#ifndef OFFENSE_COIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define OFFENSE_COIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // OFFENSE_COIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
