...
/* Offense_Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "OFFENSE_COIN"
#define QAPP_ORG_DOMAIN "offense_coin.org"
#define QAPP_APP_NAME_DEFAULT "OFFENSE_COIN-Qt"
#define QAPP_APP_NAME_TESTNET "OFFENSE_COIN-Qt-testnet"
