...
#ifndef OFFENSE_COIN_CORE_NEW_GUI_OFFENSE_COINGUI_H
#define OFFENSE_COIN_CORE_NEW_GUI_OFFENSE_COINGUI_H
...
#include "qt/offense_coin/navmenuwidget.h"
#include "qt/offense_coin/topbar.h"
#include "qt/offense_coin/dashboardwidget.h"
#include "qt/offense_coin/send.h"
#include "qt/offense_coin/receivewidget.h"
#include "qt/offense_coin/addresseswidget.h"
#include "qt/offense_coin/coldstakingwidget.h"
#include "qt/offense_coin/governancewidget.h"
#include "qt/offense_coin/masternodeswidget.h"
#include "qt/offense_coin/snackbar.h"
#include "qt/offense_coin/settings/settingswidget.h"
...
/**
  OFFENSE_COIN GUI main class. This class represents the main window of the OFFENSE_COIN UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class OFFENSE_COINGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit OFFENSE_COINGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~OFFENSE_COINGUI();
...
#endif //OFFENSE_COIN_CORE_NEW_GUI_OFFENSE_COINGUI_H
