...
#include "qt/offense_coin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(OFFENSE_COINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &OFFENSE_COINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
