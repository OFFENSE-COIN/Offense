...
#include "qt/offense_coin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/offense_coin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(OFFENSE_COINGUI* _window, QWidget *parent) :
