...
#include "qt/offense_coin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/offense_coin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(OFFENSE_COINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to OFFENSE_COINGUI::handleRestart()
