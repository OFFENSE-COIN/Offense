...
#include "qt/offense_coin/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(OFFENSE_COINGUI* _window,QWidget *parent) :
