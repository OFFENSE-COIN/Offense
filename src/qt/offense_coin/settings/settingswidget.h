...
#include <QWidget>
#include "qt/offense_coin/pwidget.h"
#include "qt/offense_coin/settings/settingsbackupwallet.h"
#include "qt/offense_coin/settings/settingsexportcsv.h"
#include "qt/offense_coin/settings/settingsbittoolwidget.h"
#include "qt/offense_coin/settings/settingssignmessagewidgets.h"
#include "qt/offense_coin/settings/settingswalletrepairwidget.h"
#include "qt/offense_coin/settings/settingswalletoptionswidget.h"
#include "qt/offense_coin/settings/settingsmainoptionswidget.h"
#include "qt/offense_coin/settings/settingsdisplayoptionswidget.h"
#include "qt/offense_coin/settings/settingsinformationwidget.h"
#include "qt/offense_coin/settings/settingsconsolewidget.h"

class OFFENSE_COINGUI;
...
public:
    explicit SettingsWidget(OFFENSE_COINGUI* parent);
    ~SettingsWidget();
