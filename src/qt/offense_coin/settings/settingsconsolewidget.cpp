...
#include "qt/offense_coin/settings/forms/ui_settingsconsolewidget.h"
...
SettingsConsoleWidget::SettingsConsoleWidget(OFFENSE_COINGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(RPCExecutor::CMD_REPLY, (tr("Welcome to the OFFENSE COIN RPC console.") + "<br>" +
