...
#include "qt/offense_coin/settings/settingsnetworkwidget.h"
#include "qt/offense_coin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/offense_coin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(OFFENSE_COINGUI* _window, QWidget *parent) :
