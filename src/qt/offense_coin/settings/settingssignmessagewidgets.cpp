...
#include "qt/offense_coin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(OFFENSE_COINGUI* _window, QWidget *parent) :
