...
#include <QWidget>
#include <QString>
#include "qt/offense_coin/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(OFFENSE_COINGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    OFFENSE_COINGUI* getWindow() { return this->window; }
