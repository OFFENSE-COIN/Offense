...
#include "qt/offense_coin/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, OFFENSE_COINGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
