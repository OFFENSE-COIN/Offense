...
#ifndef OFFENSE_COIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define OFFENSE_COIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //OFFENSE_COIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
