...
#include "qt/offense_coin/forms/ui_masternodewizarddialog.h"
    ...
    clientModel(_clientModel)
{
    ...
    ui->labelMessage1a->setText(formatHtmlContent(
                formatParagraph(tr("To create a OFFENSE COIN Masternode you must dedicate OFFENSE COIN (the unit of OFFENSE COIN) "
