...
#include "qt/offense_coin/createproposaldialog.h"
#include "qt/offense_coin/forms/ui_createproposaldialog.h"

#include "qt/offense_coin/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(OFFENSE_COINGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.offense_coin/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 OFC");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<OFFENSE_COINGUI*>(parent()),
                this
        );
