...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            OFFENSE_COINGUI* window = static_cast<OFFENSE_COINGUI*>(parentWidget());
...
{
    OFFENSE_COINGUI* gui = static_cast<OFFENSE_COINGUI*>(parentWidget());
...
{
    hide();
    static_cast<OFFENSE_COINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("%1 will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your OFCs from being stolen by malware infecting your computer.").arg(PACKAGE_NAME) +
            "<br><br><b>" +
