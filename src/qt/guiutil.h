...
/** Utility functions used by the OFFENSE_COIN Qt UI.
 */
namespace GUIUtil
{
...
// Render OFFENSE_COIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZofc = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZofc = false);
...
// Parse "offense_coin:" URI into recipient object, return true on successful parsing
