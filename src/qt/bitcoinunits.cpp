...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(OFC);
    unitlist.append(mOFC);
    unitlist.append(uOFC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case OFC:
        return QString("offense_coin");
    case mOFC:
        return QString("moffense_coin");
    case uOFC:
        return QString::fromUtf8("uoffense_coin");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool iszofc)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZOFC)
{
    QSettings settings;
...
QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZOFC)
{
