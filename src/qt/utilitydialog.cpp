                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("OFFENSE COIN") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About OFFENSE COIN"));
        ...
        licenseInfoHTML.replace(uri, "<a style='color: #87C6FF;text-decoration:none'  href=\"\\1\">\\1</a>");
        ...
        QString header = "Usage:  offense_coin-qt [command-line options]                     \n";
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("OFFENSE COIN is shutting down...") + "<br /><br />" +
