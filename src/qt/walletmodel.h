...
#ifndef OFFENSE_COIN_QT_WALLETMODEL_H
#define OFFENSE_COIN_QT_WALLETMODEL_H
...
/** Interface to OFFENSE_COIN wallet from Qt view code. */
...
#endif // OFFENSE_COIN_QT_WALLETMODEL_H
