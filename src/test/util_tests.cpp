...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("offense_coin"), "Offense_Coin");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://offense_coin.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/offense_coin"));
    BOOST_CHECK(validateURL("https://foo.bar/offense_coin/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.offense_coin.com"));
