...
#ifndef OFFENSE_COIN_WALLET_H
#define OFFENSE_COIN_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_OFFENSE_COIN = 61000, // inherited version..
...
public:
     ...
     * OFFENSE_COIN: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 OFC output and keys which can be used for the Masternode
