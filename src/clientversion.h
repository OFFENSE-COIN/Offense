...
#error Client version information missing: version is not defined by offense_coin-config.h or in any other way
#endif
...
/**
 * offense_coind-res.rc includes this file, but it cannot cope with real c++ code.
