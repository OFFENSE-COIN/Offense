Contributing to OFFENSE_COIN
============================

The OFFENSE_COIN project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/offense_coin-project/offense_coin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the OFFENSE_COIN project, and is not to be
confused with overall OFFENSE_COIN Network Protocol consensus changes.

Whether a pull request is merged into OFFENSE_COIN rests with the project merge
...
Patches that change OFFENSE_COIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the OFFENSE_COIN consensus, it must have been
...
The project leader is the release manager for each OFFENSE_COIN release.
