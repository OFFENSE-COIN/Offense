...
COIN = 100000000 # 1 OFC in satoshis
...
# Objects that map to offense_coind objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in offense_coind indicates these should be deserialized as blocks
