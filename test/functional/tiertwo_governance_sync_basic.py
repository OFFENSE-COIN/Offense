...
from test_framework.test_framework import Offense_CoinTier2TestFramework
...
class MasternodeGovernanceBasicTest(Offense_CoinTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.offense_coin.org/t/test-proposal",
            2,
