...
By default, offense_coind will dump mempool on shutdown and
...
class MempoolPersistTest(Offense_CoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent offense_coind from writing mempool.dat to disk. Verify that `savemempool` fails")
