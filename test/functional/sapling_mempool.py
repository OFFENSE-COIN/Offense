#!/usr/bin/env python3
# Copyright (c) 2020 The OFFENSE_COIN developers
...
class SaplingMempoolTest(Offense_CoinTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 OFC note to Alice
        ...
        # miner sends another 10 OFC note to Alice
