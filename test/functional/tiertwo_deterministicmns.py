#!/usr/bin/env python3
# Copyright (c) 2021 The OFFENSE_COIN developers
...
class DIP3Test(Offense_CoinTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 OFC) to the operator, and (2 * 2.7 OFC) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid OFFENSE_COIN address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid OFFENSE_COIN address InvalidPayee", controller.protx_update_registrar,
