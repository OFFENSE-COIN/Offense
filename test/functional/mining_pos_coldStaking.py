...
class OFFENSE_COIN_ColdStakingTest(Offense_CoinTestFramework):
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 OFC from the pot)
...
if __name__ == '__main__':
    OFFENSE_COIN_ColdStakingTest().main()
