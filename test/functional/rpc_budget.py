...
class BudgetProposalTest(Offense_CoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid OFFENSE_COIN address")
        assert_raises_rpc_error(-5, "Invalid OFFENSE_COIN address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 OFC allowed" % invalid_amt, self.nodes[0].preparebudget,
