...
Also test that nodes that send unsupported service bits to offense_coind are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if offense_coind ban behavior changes
    def on_open(self):
        super().on_open()
...
class P2PLeakTest(Offense_CoinTestFramework):
