...
class BlockIndexStatsTest(Offense_CoinTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 OFC "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 OFC + 9 notes of 5 OFC + 1 note of 4 OFC (using 1.0 fee)
