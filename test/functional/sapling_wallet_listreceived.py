...
class ListReceivedTest (Offense_CoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 OFC.
        ...
        # Send 1 OFC to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 OFC sending them all (fee is 0.1 OFC)
        ...
        # Confirm transaction (2 OFC from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 OFC, send 0.6 OFC + 0.05 OFC fee
