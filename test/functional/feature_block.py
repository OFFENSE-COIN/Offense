...
class FullBlockTest(Offense_CoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure offense_coind isn't accepting b26
        ...
        # Extend the b28 chain to make sure offense_coind isn't accepting b28
        ...
        # OFFENSE_COIN: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the offense_coin code has custom code which does so);
