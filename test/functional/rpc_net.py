...
class NetTest(Offense_CoinTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 18171)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 18171)
