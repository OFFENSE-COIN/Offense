...
Provides utilities for managing copyright headers of `The OFFENSE_COIN
...
OFFENSE_COIN-Project/OFFENSE_COIN repository.
...
Setup
---------
Configuring the github-merge tool for the OFFENSE_COIN repository is done in the following way:

    git config githubmerge.repository OFFENSE_COIN-Project/OFFENSE_COIN
...
A script to optimize png files in the OFFENSE_COIN
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_offense_coin: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_offense_coin: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_offense_coin: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_offense_coin: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
