...
def main():
    ...
    # Filter out hosts with multiple offense_coin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple offense_coin ports' % (ip_stats(ips)), file=sys.stderr)
